...
#ifndef _CHARS_S_H_
#define _CHARS_S_H_
const byte S_BYTES_PER_COLUMN = 1;
const byte S_BYTES_PER_ROW = 1;
const byte S_CHAR_WIDTH = 6;
const byte S_CHAR_HEIGHT = 8;
const byte S_CHAR_DIR = 1; //vertical
//ascii chars with offset of 32, starting with space
const byte S_CHARS[95][5] = {
