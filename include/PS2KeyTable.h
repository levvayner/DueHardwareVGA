...
const uint8_t single_key[][ 2 ] = {
                ...
                { PS2_KC_8, PS2_KEY_8 },
                { PS2_KC_9, PS2_KEY_9 },
                { PS2_KC_APOS, PS2_KEY_SINGLE_QUOTE },
...
const uint8_t extended_key[][ 2 ] = {
                ...
                { PS2_KC_STOP, PS2_KEY_OPEN_CU },
                { PS2_KC_PLAY, PS2_KEY_PIPE },
                { PS2_KC_MUTE, PS2_KEY_CLOSE_CU },
                { PS2_KC_VOL_UP, PS2_KEY_TILDE },
                { PS2_KC_VOL_DN, PS2_KEY_TILDE },
